...
(function ($) {
	...
	$.Poshytip.prototype = {
		...
		refresh:      function (async) {
			...
			if (async && this.opts.refreshAniDuration) {
				...
				var self = this;
				this.$tip.css(currPos).animate({left:this.pos.l, top:this.pos.t}, this.opts.refreshAniDuration, function () {
	...
	$.fn.poshytip.defaults = {
		...
		className:         'tip-normal', // class for the tips
